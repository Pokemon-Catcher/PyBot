...
async def aiPlay():
    ...
    try:
        ...
        serialized_data, _, _ = load_from_zip_file("models/self_play_snapshot_1800k.zip")
    ...
    try:
        with zipfile.ZipFile("models/self_play_snapshot_1800k.zip", "r") as archive:
    ...
    while True:
        try:
            ...
            await player.accept_challenges(None, None)
        except Exception as e:
